      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p class="text-sm leading-relaxed">A modern Angular application built with Tailwind CSS.</p>
          </div>

          <div>
            <h3 class="text-white font-semibold mb-4">Navigation</h3>
            <ul class="space-y-2 text-sm">
              <li><a routerLink="/" class="hover:text-indigo-400 transition-colors">Home</a></li>
              <li><a routerLink="/about" class="hover:text-indigo-400 transition-colors">About</a></li>
              <li><a routerLink="/privacy" class="hover:text-indigo-400 transition-colors">Privacy</a></li>
            </ul>
          </div>
